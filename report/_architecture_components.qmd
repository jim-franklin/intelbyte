...
![Power Apps](assets/PowerApps_scalable.png){fig-alt="Power Apps icon" width=90}

![Power BI](assets/PowerBI_scalable.png){fig-alt="Power BI icon" width=90}
...
![Dataverse](assets/Dataverse_scalable.png){fig-alt="Dataverse icon" width=90}
...
![Power Automate](assets/PowerAutomate_scalable.png){fig-alt="Power Automate icon" width=90}
